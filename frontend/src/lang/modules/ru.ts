...
const message = {
    commons: {
        ...
        login: {
            ...
            agreeContent:
                'Для лучшей защиты ваших законных прав и интересов, пожалуйста, прочитайте и согласитесь со следующим соглашением &laquo;  Лицензионное соглашение сообщества  &raquo;',
    ...
    website: {
        ...
        encryptHelper:
            "Let's Encrypt имеет ограничение частоты выдачи сертификатов, но его достаточно для нормальных потребностей. Слишком частые операции приведут к сбою выдачи. Конкретные ограничения см. в официальной документации",
        ipValue: 'Значение',
    ...
    xpack: {
        ...
        sync: {
            ...
            cert: 'Синхронизация сертификатов',
            certBatchDesc:
                'После выбора исходного узла указанные сертификаты можно синхронизировать с текущей средой панели.',
            certBatchConfirmPrefix: 'Будет синхронизировано {0} сертификатов на {1} узлов, всего {2} задач.',
